...
python3 train.py --name drive --resize_or_crop none --dataroot=/zhome/95/c/135723/Datasets/DRIVE_HD/ --input_nc 1 --no_instance --nThreads 1 --label_nc=1 --resize_or_crop scale_width --gpu_ids 0
